...
import { facilityMiddleware } from "@/lib/middleware";
...
export const Route = createFileRoute("/_facility")({
  server: {
    middleware: [facilityMiddleware],
  },
    ...
    <div className="flex min-h-screen">
      <aside className="sticky top-0 flex h-screen w-64 flex-col border-r bg-muted/30">
        ...
        <nav className="flex-1 space-y-1 overflow-y-auto px-3">
          ...
          <MessagesNavLink to="/facility/messages" />
          <Link
